...
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO megavncuser;
GRANT USAGE ON SCHEMA public TO megavncuser;
GRANT INSERT, SELECT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO megavncuser;